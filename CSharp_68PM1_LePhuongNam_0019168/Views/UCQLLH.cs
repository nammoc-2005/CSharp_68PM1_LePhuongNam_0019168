namespace CSharp_68PM1_LePhuongNam_0019168
{
    public partial class UCQLLH : UserControl
    {
        ...
        private void btnTim_Click(object sender, EventArgs e) { currentPage = 1; LoadDanhSach(txtTimKiem.Text.Trim()); }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            DataStore.DanhSachLop.Add(new LopHoc { MaID = maID, MaLop = txtMaLop.Text.Trim(), TenLop = txtTenLop.Text.Trim(), GhiChu = txtGhiChu.Text.Trim() });
        ...
        private void LamMoi()
        {
            txtMaID.Text = ""; txtMaLop.Text = "";
            txtTenLop.Text = ""; txtGhiChu.Text = "";
        }
        ...
        private void btnXemSinhVien_Click(object sender, EventArgs e)
        {
            ...
            var frmXem = new Form { Text = $"Sinh viên lớp {txtMaLop.Text}", Size = new Size(700, 400), StartPosition = FormStartPosition.CenterParent };
            var dgv = new DataGridView
            {
                ...
                DataSource = svList.Count > 0
                    ? (object)svList.Select(sv => new { sv.MaSV, sv.HoTen, sv.GioiTinh, NgaySinh = sv.NgaySinh.ToString("dd/MM/yyyy"), sv.MaLop }).ToList()
                    : new List<object>()
            };
            if (svList.Count == 0)
                MessageBox.Show($"Lớp {txtMaLop.Text} chưa có sinh viên.", "Thông báo");
            else { frmXem.Controls.Add(dgv); frmXem.ShowDialog(); }
        }
