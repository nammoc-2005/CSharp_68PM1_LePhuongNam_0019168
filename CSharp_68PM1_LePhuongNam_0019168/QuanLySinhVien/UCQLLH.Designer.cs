...
namespace CSharp_68PM1_LePhuongNam_0019168
{
    partial class UCQLLH
    {
        ...
        {
            var pnlLeft = new Panel { Width = 440, Dock = DockStyle.Left, BackColor = Color.FromArgb(245, 245, 245), Padding = new Padding(20) };

            var lblInfo = new Label { Text = "Thông tin lớp học", Font = new Font("Segoe UI", 11, FontStyle.Bold), Location = new Point(20, 15), AutoSize = true };

            var lblMaID = new Label { Text = "Mã ID:", Location = new Point(20, 55), AutoSize = true };
            txtMaID = new TextBox { Location = new Point(20, 75), Width = 390, Height = 32, ReadOnly = true, BackColor = Color.AliceBlue, Font = new Font("Segoe UI", 10) };

            var lblMaLop = new Label { Text = "Mã lớp:", Location = new Point(20, 120), AutoSize = true };
            txtMaLop = new TextBox { Location = new Point(20, 140), Width = 390, Height = 32, Font = new Font("Segoe UI", 10) };

            var lblTenLop = new Label { Text = "Tên lớp:", Location = new Point(20, 185), AutoSize = true };
            txtTenLop = new TextBox { Location = new Point(20, 205), Width = 390, Height = 32, Font = new Font("Segoe UI", 10) };

            var lblGhiChu = new Label { Text = "Ghi chú:", Location = new Point(20, 250), AutoSize = true };
            txtGhiChu = new TextBox { Location = new Point(20, 270), Width = 390, Height = 32, Font = new Font("Segoe UI", 10) };

            btnThem = new Button { Text = "Thêm", Location = new Point(20, 340), Width = 185, Height = 50, BackColor = Color.FromArgb(30, 136, 229), ForeColor = Color.White, FlatStyle = FlatStyle.Flat, Font = new Font("Segoe UI", 11, FontStyle.Bold), Cursor = Cursors.Hand };
            btnThem.FlatAppearance.BorderSize = 0;

            btnSua = new Button { Text = "Sửa", Location = new Point(225, 340), Width = 185, Height = 50, BackColor = Color.FromArgb(56, 142, 60), ForeColor = Color.White, FlatStyle = FlatStyle.Flat, Font = new Font("Segoe UI", 11, FontStyle.Bold), Cursor = Cursors.Hand };
            btnSua.FlatAppearance.BorderSize = 0;

            btnXoa = new Button { Text = "Xóa", Location = new Point(20, 405), Width = 185, Height = 50, BackColor = Color.FromArgb(211, 47, 47), ForeColor = Color.White, FlatStyle = FlatStyle.Flat, Font = new Font("Segoe UI", 11, FontStyle.Bold), Cursor = Cursors.Hand };
            btnXoa.FlatAppearance.BorderSize = 0;

            btnLamMoi = new Button { Text = "Làm mới", Location = new Point(225, 405), Width = 185, Height = 50, BackColor = Color.FromArgb(117, 117, 117), ForeColor = Color.White, FlatStyle = FlatStyle.Flat, Font = new Font("Segoe UI", 11, FontStyle.Bold), Cursor = Cursors.Hand };
            btnLamMoi.FlatAppearance.BorderSize = 0;

            btnXemSinhVien = new Button { Text = "Xem danh sách sinh viên", Location = new Point(20, 470), Width = 390, Height = 50, BackColor = Color.FromArgb(0, 121, 107), ForeColor = Color.White, FlatStyle = FlatStyle.Flat, Font = new Font("Segoe UI", 11, FontStyle.Bold), Cursor = Cursors.Hand };
            btnXemSinhVien.FlatAppearance.BorderSize = 0;

            btnThem.Click += btnThem_Click; btnSua.Click += btnSua_Click;
            btnXoa.Click += btnXoa_Click; btnLamMoi.Click += btnLamMoi_Click;
            btnXemSinhVien.Click += btnXemSinhVien_Click;

            pnlLeft.Controls.AddRange(new Control[] { lblInfo, lblMaID, txtMaID, lblMaLop, txtMaLop, lblTenLop, txtTenLop, lblGhiChu, txtGhiChu, btnThem, btnSua, btnXoa, btnLamMoi, btnXemSinhVien });

            var pnlRight = new Panel { Dock = DockStyle.Fill, Padding = new Padding(15) };

            var pnlSearch = new Panel { Height = 65, Dock = DockStyle.Top };
            var lblTimKiem = new Label { Text = "Tìm kiếm (Mã ID / Mã lớp / Tên lớp):", Location = new Point(0, 8), AutoSize = true, Font = new Font("Segoe UI", 10) };
